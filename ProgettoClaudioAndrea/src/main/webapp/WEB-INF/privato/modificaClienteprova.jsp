						...
						<div class="form-main">
							...
							<s:form id="form" class="form" method="post"
								...
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<s:label for="verificaPassword" class="font-weight-bold">Verifica Password</s:label>
											<s:password id="verificaPassword"
												placeholder="Riscrivi Password" name="verificaPassword" />
											<s:fielderror fieldName="verificaPassword" />
										</div>
									</div>
									<div class="col-12">
